...
static const char *const yytname[] =
{
  ...
  "STRING", "$accept", "snazzle", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* snazzle: INT snazzle  */
#line 40 "snazzle.y"
                     {
      cout << "bison found an int: " << (yyvsp[-1].ival) << endl;
    }
#line 1068 "snazzle.tab.c"
    break;
...
#line 1092 "snazzle.tab.c"
    break;

  case 6: /* snazzle: FLOAT  */
#line 52 "snazzle.y"
                   {
      cout << "bison found a float: " << (yyvsp[0].fval) << endl;
    }
#line 1100 "snazzle.tab.c"
    break;
