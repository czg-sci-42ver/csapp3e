#! /bin/bash
################
# 1. notice as https://unix.stackexchange.com/questions/752529/sed-used-in-the-function-of-the-bash-script-fails syas.
# this script shouldn't have executable property.
# 2. run . ../sed_no_ocr.sh E4.13.4_orig.v E4.13.4_orig_bk.v;  
...
concatenation(){
    ...
    # https://stackoverflow.com/a/3015681/21294350 or this duplicate https://unix.stackexchange.com/questions/752529/
